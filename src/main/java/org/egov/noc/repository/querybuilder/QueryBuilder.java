...
public class QueryBuilder {
	...
	public static final String GET_NOC_REMARKS_QUERY = "select ED.* from egpm_noc_application_remark ED,egpm_noc_application EA \r\n"
			+ "WHERE ED.application_uuid=EA.application_uuid \r\n" + "and ED.tenant_id=EA.tenant_id\r\n"
